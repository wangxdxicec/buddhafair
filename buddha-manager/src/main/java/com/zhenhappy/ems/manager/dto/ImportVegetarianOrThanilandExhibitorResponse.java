 ...
 */
public class ImportVegetarianOrThanilandExhibitorResponse extends BaseResponse {
    public String result;
    public String isExistData;
    public String willImportData;

    public ImportVegetarianOrThanilandExhibitorResponse() {
    }

    public ImportVegetarianOrThanilandExhibitorResponse(String result, String isExistData, String willImportData) {
        this.result = result;
