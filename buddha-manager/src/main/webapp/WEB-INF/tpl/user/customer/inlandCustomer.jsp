...
<div id="tabs" class="easyui-tabs" data-options="fit:true,border:false,plain:true">
	<div title="客商列表" style="padding:5px">
		<table id="customers" data-options="url:'${base}/user/queryInlandCustomersByPage?pre=0',
         						   loadMsg: '数据加载中......',
			...
			<tr>
				...
				<th data-options="field: 'isMobile', formatter:formatSource, width: $(this).width() / 8">
					来源<br/>
					<select id="customerSource" style="width:104%;height:21px;" onchange="filter();">
