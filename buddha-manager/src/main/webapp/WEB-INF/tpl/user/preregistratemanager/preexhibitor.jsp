...
<div id="tabs" class="easyui-tabs" data-options="fit:true,border:false,plain:true">
	<div title="展商列表" style="padding:5px">
		<table id="exhibitors" data-options="url:'${base}/user/queryExhibitorsByPage?type=0&pre=1',
            								 loadMsg: '数据加载中......',
...
<div id="importExhibitorsDlg" data-options="iconCls:'icon-add',modal:true">
	<form id="importExhibitorsForm" name="importExhibitorsForm">
	   	<table style="width: 320px;margin: 20px auto">
			<tr>
				<td colspan="2" style="width: 90px;text-align: left"><a href="${base}/resource/normalExhibitorTemplate.xls">下载导入模版</a><br /></td>
			</tr>
			<tr>
...
<div id="toolbar">
	...
	<div id="import" style="width:100px;">
		<div id="importExhibitorTemplate" iconCls="icon-undo"><a href="${base}/resource/normalExhibitorTemplate.xls">下载导入模版</a></div>
